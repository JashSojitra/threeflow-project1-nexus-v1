...
import { intakeToggles, locationOptions, ministryOptions, type FormState } from '../data';
...
const textFields: { key: keyof FormState; label: string; icon: string }[] = [
  ...
  { key: 'newMinistry', label: 'New ministry', icon: 'building' },
  { key: 'newTeam', label: 'New team / division', icon: 'building' },
