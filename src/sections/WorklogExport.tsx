...
import { Card, SectionTitle, ActionButton, StatusPill, ApprovalTag, EmptyState, ConfirmationDialog } from '../ui';
import {
  FileDown,
  FileText,
  Trash2,
  ...
  if (!bundleGenerated) {
    return (
      <div className="animate-fade-in">
        <SectionTitle eyebrow="Step 6" title="Export and Reset" description="" />
        <EmptyState
          icon={Package}
  ...
  return (
    <div className="animate-fade-in">
      ...
      <ConfirmationDialog
        ...
        description="This clears the intake, generated drafts, and temporary AI inputs. Export the worklog first if you need a local record."
        confirmLabel="End session"
        onConfirm={resetSessionNow}
